...
export default function App() {
  ...
  return (
    <div className={`w-full h-full bg-black text-white${accessibilitySettings.customContrastEnabled ? " high-contrast" : ""}${accessibilitySettings.largerText ? " larger-text" : ""}`} style={{ minHeight: "100vh", WebkitUserSelect: "none", userSelect: "none", "--contrast-level": accessibilitySettings.customContrast, "--text-scale": accessibilitySettings.textScale } as React.CSSProperties}>
      {showNamePrompt && (
        <div
      ...
      {screen === "playing" && (
        <GameCanvas
          ...
          reduceFlashing={accessibilitySettings.reduceFlashing}
          touchMode={touchMode}
