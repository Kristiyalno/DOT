    ...
    <div className="my-auto py-6 flex gap-6 w-full">
      ...
      <div className="flex flex-col gap-4 flex-1 min-w-0">
        ...
        <div className="border border-[#222] overflow-hidden">
          <div className="grid grid-cols-[3rem_20rem_18rem_6rem_9rem_9rem] text-[10px] text-zinc-500 uppercase tracking-widest font-black bg-[#0a0a0a] border-b border-[#222] px-5 py-3">
            <span>#</span>
            <span>Name</span>
          ...
          {loading ? (
            ...
            entries.map((entry, i) => {
              ...
              return (
                <div
                  key={entry.id || i}
                  className={`grid grid-cols-[3rem_20rem_18rem_6rem_9rem_9rem] items-center px-5 py-3.5 border-b border-[#111] text-sm font-mono transition-colors ${
